...
import instanzGenerator.InstanzGeneratorJsonIntervalProfitJobsOnMachineWithPrecentage;
...
public class OFISP implements Runnable {
	...
	@Option(names = { "-cor", "--corrolation" }, defaultValue = "10", description = " defines the corrolation for a job weight")
	int corrolation;
	@Option(names = { "-mw", "--maxWeight" }, description = "max weight which a job can have ")
	int maxWeight;
	
	@Option(names = { "-grw",
			"--generateInstanceWithRandomWeight" }, arity = "7", description = "this is the command to generate an instance with random weight. 7 parameter in the following sequence are needed"
	...
	@Option(names = { "-giw",
			"--generateInstanceWithIntervalWeight" }, arity = "6", description = "this is the command to generate an instance with random weight. 6 parameter in the following sequence are needed"
	...
	@Option(names = { "-giwp",
			"--generateInstanceWithIntervalWeightWithJobAssignementPrecentage" }, arity = "6", description = "this is the command to generate an instance with random weight. 6 parameter in the following sequence are needed"
	...
	String[] configurationsForIntervalWeightWithJobAssignementPrecentage;
	@Option(names = { "-sc",
	...
	public void run() {
		...
		if (configurationsForRandomWeight != null) {
			...
			String outputPath = "";
			try {
				numberOfJobs = Integer.parseInt(configurationsForRandomWeight[0]);
			} catch (Exception e) {
				System.out
			...
			try {
				numberOfMachines = Integer.parseInt(configurationsForRandomWeight[1]);
			} catch (Exception e) {
				System.out.println(
			...
			try {
				numberOfIntevals = Integer.parseInt(configurationsForRandomWeight[2]);
			} catch (Exception e) {
				System.out.println(
			...
			try {
				maxWeightDistribution = Integer.parseInt(configurationsForRandomWeight[3]);
			} catch (Exception e) {
				System.out.println(
			...
			String outputPath = "";
			try {
				numberOfJobs = Integer.parseInt(configurationsForIntervalWeight[0]);
			} catch (Exception e) {
				System.out
						.println("Error: could not convert the number of jobs, please give a positive integer number");
				return;
			...
			try {
				numberOfMachines = Integer.parseInt(configurationsForIntervalWeight[1]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of machines, please give a positive integer number");
				return;
			...
			try {
				numberOfIntevals = Integer.parseInt(configurationsForIntervalWeight[2]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of Intervals, please give a positive integer number");
				return;
			...
			try {
				jobOnMaxMachine = Integer.parseInt(configurationsForIntervalWeight[3]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of machines for a job, please give a positive integer number");
				return;
			...
			try {
				fileName = configurationsForIntervalWeight[4].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the filename, please give a filename as string");
				return;
			}
			try {
				outputPath = configurationsForIntervalWeight[5].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the outputPath, please give a valid path");
				return;
			}
			...
			try {
				jobOnMaxMachine = Integer.parseInt(configurationsForRandomWeight[3]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of machines for a job, please give a positive integer number");
				return;
			...
			InstanzGeneratorJsonIntervalProfitWithCor.generateInstanceWithIntevalCorrolationProfit(numberOfJobs,
					numberOfMachines, numberOfIntevals, jobOnMaxMachine, corrolation, fileName, outputPath);

		} 
		else if (configurationsForIntervalWeightWithJobAssignementPrecentage != null) {
			...
			String outputPath = "";
			try {
				numberOfJobs = Integer.parseInt(configurationsForIntervalWeightWithJobAssignementPrecentage[0]);
			} catch (Exception e) {
				System.out
						.println("Error: could not convert the number of jobs, please give a positive integer number");
				return;
			...
			try {
				numberOfMachines = Integer.parseInt(configurationsForIntervalWeightWithJobAssignementPrecentage[1]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of machines, please give a positive integer number");
				return;
			...
			try {
				numberOfIntevals = Integer.parseInt(configurationsForIntervalWeightWithJobAssignementPrecentage[2]);
			} catch (Exception e) {
				System.out.println(
						"Error: could not convert the number of Intervals, please give a positive integer number");
				return;
			...
			try {
				percentage = Integer.parseInt(configurationsForIntervalWeightWithJobAssignementPrecentage[3]);
			} catch (Exception e) {
				System.out.println("Error: could not convert the corrolation, please give a positive integer number");
				return;
			}
			try {
				fileName = configurationsForIntervalWeightWithJobAssignementPrecentage[4].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the filename, please give a filename as string");
				return;
			}
			try {
				outputPath = configurationsForIntervalWeightWithJobAssignementPrecentage[5].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the outputPath, please give a valid path");
				return;
			}
			InstanzGeneratorJsonIntervalProfitJobsOnMachineWithPrecentage.generateInstanceWithIntevalProfitJobAssigementPrecentage(numberOfJobs,
			...
			try {
				inputPath = configurationsForRandomWeight[0].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the input path, please give a valid path");
				return;
			}
			try {
				outputPath = configurationsForRandomWeight[1].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the output path, please give a output path as string");
				return;
			}
			try {
				fileName = configurationsForRandomWeight[2].toString();
			} catch (Exception e) {
				System.out.println("Error: could not parse the filename, please give a filename as string");
				return;
			}
			...
			System.out.println(pathOfTheInstanceToBeRead);
			System.out.println(pathOfTheInstanceToBesSavedTo);
