...
public class IGIntervalProfit {

	public static void generateInstanceWithIntervalProfit(int numberOfJobs, int numberOfMachines ,int numberOfIntervals,
			int jobOnMaxMachines, String fileName,String path) {
		 
		 String type = "Interval-Profit instance";
		 String description = "this is an interval profit instance with " + numberOfJobs+ " jobs and "+ numberOfMachines 
				 +" machines and an interval lenght of " + numberOfIntervals + ". The maximum job on a mashine is " + jobOnMaxMachines;
